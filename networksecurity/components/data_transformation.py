...
class DataTransformation:
    ...
    def get_data_transformer_object(self)->Pipeline:
        logging.info("Entered get_data_transformer_object method of the Transformer class")
        try:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            logging.info("Entered initiate_data_transformation method of the DataTransformation class")
